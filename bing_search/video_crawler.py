...
BASE_URL = "https://www.bing.com/videos/search?"
...
def image_url_from_webpage(driver, max_number=10000):
    ...
    while True:
        image_elements = driver.find_elements_by_class_name("vrhdata")
    ...
    for image_element in image_elements:
        ...
        image_urls.append(m_json["ourl"])
    return image_urls


def crawl_image_urls(keywords, filters, max_number=10000, proxy=None, proxy_type="http"):
    chrome_path = shutil.which("chromedriver")
    chrome_path = "/Users/bgalitsky/PycharmProjects/chromedriver" if chrome_path is None else chrome_path
